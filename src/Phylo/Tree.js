...
export default function Tree(props) {
  ...
  const svgHeight = layout === "circular" ? innerRadius * 2 : leafNodes * 20;
  const svgWidth = layout === "circular" ? innerRadius * 2 : leafNodes * 30; //360 for extra area to vis text
  ...
  return (
    <div>
      ...
      <a
        href={`${process.env.PUBLIC_URL}/option.html`}
        // target="_blank"
